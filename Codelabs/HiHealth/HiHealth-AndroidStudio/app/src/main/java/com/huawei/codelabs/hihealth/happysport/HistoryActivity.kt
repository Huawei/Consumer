...
import com.huawei.codelabs.hihealth.happysport.adapters.RunningSportAdapter
...
class HistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = RunningSportAdapter(applicationContext)
        binding.runningSportList.adapter = adapter
        subscribeUi(adapter)
    }

    private fun subscribeUi(adapter: RunningSportAdapter) {
