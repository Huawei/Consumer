    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConfirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Editable[] passwordEditableArray = new Editable[6];
                String[] passwordArray = new String[6];
                for (int i = 0; i < 6; i++) {
                    passwordEditableArray[i] = mPasswordEditTextArray[i].getText();
                    if (passwordEditableArray[i] != null) {
                        passwordArray[i] = passwordEditableArray[i].toString();
                    }
                }
                ...
                for(int i = 0;i < 6;i++){
                    if(passwordArray[i] != null){
                        passwordStringBuilder.append(passwordArray[i]);
                    }
                }
                ...
                if (TextUtils.isEmpty(mPasswordEditText.getText()) || mPasswordEditText.getText().toString().length()!=6){
                    Toast.makeText(PasswordActivity.this, "请输入六位数字密码", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (checkPassword(password)) {
                    ...
                    Toast.makeText(PasswordActivity.this, "密码仅支持字母及数字", Toast.LENGTH_LONG).show();
                }
            }
        });
