...
public class MainActivity extends AppCompatActivity implements View.OnFocusChangeListener {
    ...
    protected void onResume() {
        ...
        //mTvNameTextView.setText(android.os.Build.DEVICE);
        mTvNameTextView.setText(myDevice.getName());

//        mConnectivityManager =
//                (ConnectivityManager) this.getApplicationContext().getSystemService(Context
//                .CONNECTIVITY_SERVICE);
//        if (mConnectivityManager != null) {
//            NetworkInfo networkInfo = mConnectivityManager.getActiveNetworkInfo();
//            if (networkInfo != null) {
//                mWifiNameTextView.setText(networkInfo.getExtraInfo());
//            }
//        }
