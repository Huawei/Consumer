...
public class VerifySignatureUtil {
    ...
    private static final String certPath = "certs/cbg_root.cer";
    ...
    static {
        String filepath = Main.class.getResource("/").getPath() + certPath;
    ...
    public static boolean verifySignature(Jws jws)
