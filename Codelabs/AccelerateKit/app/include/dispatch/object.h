...
#define DISPATCH_SOURCE_TYPE_DECL(name) \
		DISPATCH_UNSUPPORTED struct dispatch_source_type_s \
...
#define DISPATCH_SOURCE_TYPE_DECL(name) \
		DISPATCH_UNSUPPORTED const struct dispatch_source_type_s \
		_dispatch_source_type_##name
#endif
 ...
 */
DISPATCH_UNSUPPORTED DISPATCH_NONNULL_ALL DISPATCH_PURE DISPATCH_WARN_RESULT
DISPATCH_NOTHROW
void *_Nullable
 ...
 *
 */
DISPATCH_UNSUPPORTED DISPATCH_NOTHROW
void
 ...
 */
DISPATCH_UNAVAILABLE
DISPATCH_UNSUPPORTED DISPATCH_NONNULL_ALL DISPATCH_WARN_RESULT DISPATCH_PURE
DISPATCH_NOTHROW
intptr_t
...
DISPATCH_UNSUPPORTED DISPATCH_NONNULL2 DISPATCH_NOTHROW DISPATCH_COLD
