...
DISPATCH_UNSUPPORTED struct dispatch_data_s _dispatch_data_empty;
...
#define DISPATCH_DATA_DESTRUCTOR_TYPE_DECL(name) \
	DISPATCH_UNSUPPORTED const dispatch_block_t _dispatch_data_destructor_##name
#else
#define DISPATCH_DATA_DESTRUCTOR_TYPE_DECL(name) \
	DISPATCH_UNSUPPORTED const dispatch_function_t \
 ...
 */
DISPATCH_UNSUPPORTED DISPATCH_RETURNS_RETAINED DISPATCH_WARN_RESULT DISPATCH_NOTHROW
dispatch_data_t
 ...
 */
DISPATCH_UNSUPPORTED DISPATCH_PURE DISPATCH_NONNULL1 DISPATCH_NOTHROW
size_t
 ...
 * @result		A newly created dispatch data object.
 */
DISPATCH_UNSUPPORTED DISPATCH_NONNULL1 DISPATCH_RETURNS_RETAINED
 ...
 */
DISPATCH_UNSUPPORTED DISPATCH_NONNULL_ALL DISPATCH_RETURNS_RETAINED
DISPATCH_WARN_RESULT DISPATCH_NOTHROW
dispatch_data_t
 ...
 * @result		A newly created dispatch data object.
 */
DISPATCH_UNSUPPORTED DISPATCH_NONNULL1 DISPATCH_NONNULL3 DISPATCH_RETURNS_RETAINED
DISPATCH_WARN_RESULT DISPATCH_NOTHROW
dispatch_data_t
